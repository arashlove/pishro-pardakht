...
export default function Sidebar() {
  ...
  return (
    <div
      ref={sidebar}
      className="Sidebar shadow-sm h-100 fw-bold rounded-10 text-light space-no-wrap transition bg-lg-top-to-bottom py-2"
    >
      <div
        className="content h-100 d-flex flex-column pe-3"
        style={{ width: "225px" }}
      >
        <img className="w-100 d-block ps-3" src={logo} alt="logo" />
